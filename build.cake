...
// Define directories.
var buildDir = "./src/IIS/bin/" + configuration;
var buildTestDir = "./src/IIS.Tests/bin/" + configuration;
    ...
    .Does(() =>
{
    ...
    CreateAssemblyInfo(file, new AssemblyInfoSettings
    {
        ...
        Copyright = "Copyright (c) 2015 - " + DateTime.Now.Year.ToString() + " Sergio Silveira, Phillip Sharpe"
    });
});
    ...
    .Does(() =>
{
    ...
    CopyFileToDirectory(buildDir + "/Cake.IIS.xml", binDir);
...
Task("Create-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetPack("./nuspec/Cake.IIS.nuspec", new NuGetPackSettings
    {
        Version = version,
